...
const UpdateProduct = () => {
  ...
  const GetSingleProduct = async () => {
    try {
      ...
      toast.error("Cannot get the single product");
    }
  };
...
//delete product function
  const handleDelete=async()=>{
    try {
        const answer = window.prompt("are you sure do you want to delete this product?");
        if(!answer) return;
        ...
        toast.error("cannot delete the product")
    }
  }
